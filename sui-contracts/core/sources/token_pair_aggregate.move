...
module sui_swap_core::token_pair_aggregate {
    ...
    use sui_swap_core::token_pair_add_liquidity_logic;
    use sui_swap_core::token_pair_destroy_logic;
    use sui_swap_core::token_pair_initialize_liquidity_logic;
    use sui_swap_core::token_pair_remove_liquidity_logic;
    use sui_swap_core::token_pair_swap_x_logic;
    use sui_swap_core::token_pair_swap_y_logic;
    use sui_swap_core::token_pair_update_fee_rate_logic;
    ...
    #[allow(unused_mut_parameter)]
    public entry fun update_fee_rate<X: key + store, Y>(
        token_pair: &mut token_pair::TokenPair<X, Y>,
        liquidity_token: &LiquidityToken<X, Y>,
        fee_numerator: u64,
        fee_denominator: u64,
