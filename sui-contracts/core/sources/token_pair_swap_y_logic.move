...
module sui_swap_core::token_pair_swap_y_logic {
    ...
    public(friend) fun verify<X: key + store, Y>(
        ...
        let _max_x_amount_out = swap_util::swap(
            y_reserve_amount,
            x_reserve_amount,
            y_amount_in,
            x_amount,
    ...
    public(friend) fun mutate<X: key + store, Y>(
        ...
        let x_amount = token_pair::y_swapped_for_x_x_amount(y_swapped_for_x);
        ...
        let x_id = token_pair::y_swapped_for_x_x_id(y_swapped_for_x);
