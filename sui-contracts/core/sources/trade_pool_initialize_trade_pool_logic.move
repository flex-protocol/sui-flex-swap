...
module sui_swap_core::trade_pool_initialize_trade_pool_logic {
    use std::option;
    use std::string;
    use std::type_name;
    ...
    use sui_swap_core::trade_pool_initialized;
    ...
    public(friend) fun mutate<X: key + store, Y>(
        ...
        trade_pool::set_trade_pool_initialized_liquidity_token_id(trade_pool_initialized, option::some(liquidity_token_id));
