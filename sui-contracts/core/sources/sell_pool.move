...
module sui_swap_example::sell_pool {
    ...
    public fun sell_pool_initialized_liquidity_token_id(sell_pool_initialized: &SellPoolInitialized): ID {
    ...
    public(friend) fun share_object<X: key + store, Y>(sell_pool: SellPool<X, Y>) {
        assert!(sell_pool.version == 0, EInappropriateVersion);
