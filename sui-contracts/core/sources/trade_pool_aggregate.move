...
module sui_swap_core::trade_pool_aggregate {
    ...
    use sui_swap_core::trade_pool_add_x_token_logic;
    use sui_swap_core::trade_pool_buy_x_logic;
    use sui_swap_core::trade_pool_deposit_y_reserve_logic;
    use sui_swap_core::trade_pool_destroy_logic;
    ...
    use sui_swap_core::trade_pool_withdraw_y_reserve_logic;
