...
public class NftCollectionEventId implements Serializable {
    ...
    public NftCollectionEventId()
    {
    }

    public NftCollectionEventId(String collectionType, BigInteger version)
    {
        this.collectionType = collectionType;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        NftCollectionEventId other = (NftCollectionEventId)obj;
        return true 
            && (collectionType == other.collectionType || (collectionType != null && collectionType.equals(other.collectionType)))
    ...
    public int hashCode()
    {
        ...
        if (this.collectionType != null) {
            hash += 13 * this.collectionType.hashCode();
        }
