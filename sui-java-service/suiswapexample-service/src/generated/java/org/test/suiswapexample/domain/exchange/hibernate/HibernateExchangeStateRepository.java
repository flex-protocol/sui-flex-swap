...
public class HibernateExchangeStateRepository implements ExchangeStateRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("Id", "Name", "TokenPairs", "TokenPairX_TokenTypes", "TokenPairY_TokenTypes", "TradePools", "TradePoolX_TokenTypes", "TradePoolY_TokenTypes", "SellPools", "SellPoolX_TokenTypes", "SellPoolY_TokenTypes", "BuyPools", "BuyPoolX_TokenTypes", "BuyPoolY_TokenTypes", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "Version"));
