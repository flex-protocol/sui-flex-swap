...
public class HibernateTokenPairStateQueryRepository implements TokenPairStateQueryRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("Id", "X_Reserve", "Y_Reserve", "ExchangeRateNumerator", "ExchangeRateDenominator", "Version", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "X_TokenType", "Y_TokenType"));
