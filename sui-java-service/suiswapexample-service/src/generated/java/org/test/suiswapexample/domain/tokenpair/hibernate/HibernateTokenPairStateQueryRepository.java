...
public class HibernateTokenPairStateQueryRepository implements TokenPairStateQueryRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("Id", "X_Reserve", "Y_Reserve", "ExchangeRateNumerator", "ExchangeRateDenominator", "LiquidityTokenId", "Version", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "X_TokenType", "Y_TokenType"));
    ...
    public Iterable<TokenPairState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(TokenPairState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<TokenPairState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(TokenPairState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public TokenPairState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<TokenPairState> list = (List<TokenPairState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public TokenPairState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
