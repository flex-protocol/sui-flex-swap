...
import org.test.suiswapexample.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.suiswapexample.*"); //add annotation mappings
