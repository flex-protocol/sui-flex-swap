...
public class SuiExchangeStateRetriever {
    ...
    private ExchangeState toExchangeState(Exchange exchange) {
        ...
        exchangeState.setTradePools(Arrays.asList(exchange.getTradePools()));
        exchangeState.setTradePoolX_TokenTypes(Arrays.asList(exchange.getTradePoolX_TokenTypes()));
        exchangeState.setTradePoolY_TokenTypes(Arrays.asList(exchange.getTradePoolY_TokenTypes()));
